...
```{r}
# The url for the data is ftp://ftp.ncbi.nlm.nih.gov/geo/series/GSE69nnn/GSE69360/suppl/GSE69360_RNAseq.counts.txt.gz
# name the file gse69360

# Add some code here to read and explore the data a bit
```

## An example of some exploratory data analysis using filter and select

```{r}
# keep rows with y chromosome
gse69360 %>%
    filter(grepl("chrY", Chr))
# keep rowa that have a length <= 50
gse69360 %>%
    filter(Length <= 50)
# keep rows that statisfy both of the conditions above
gse69360 %>%
